...
AI Daily Brief Skill 是一个高效的信息聚合工具，专门用于收集和整理人工智能领域的最新动态。它从多个可靠数据源（包括技术媒体、学术平台、社区论坛和社交媒体）抓取内容，通过智能过滤和热度评估，生成易于阅读的每日简报。

## 主要特性

### 📊 多源数据采集
- **RSS订阅**: 支持主流科技媒体和博客的RSS/Atom订阅
- **社交媒体**: Reddit社区、X/Twitter关键账号
